...
<head>
  ...
  <style type="text/tailwindcss">
    ...
    .input-login {
      @apply shadow-sm appearance-none border py-2 px-3 text-slate-700 leading-tight focus:outline-none rounded-md border-slate-300;
    }
...
<body class="container mx-auto mt-10 mb-10 max-w-3xl bg-slate-100">
    @yield('content')
    @if (View::hasSection('title') && View::getSection('title') === 'Book reviews')
        {{ $books->links() }}
    @endif
</body>
